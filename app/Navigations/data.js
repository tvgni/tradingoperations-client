export const navigation = [
    { id: 1, Attr: '<a href="">Dashboard</a>', icon: 'product' },
    { id: 2, Attr: '<a href="">Usuarios</a>', icon: 'money' },
    { id: 3, Attr: '<a href="">Informes01</a>', icon: 'group' },
    { id: 4, Attr: '<a href="">Informes02</a>', icon: 'card' },
    { id: 5, Attr: '<a href="">Informes03</a>', icon: 'chart' },
  ];
